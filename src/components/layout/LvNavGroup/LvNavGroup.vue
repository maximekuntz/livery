...
<script setup>
/**
 * LvNavGroup — Groups nav items with an optional section label.
 * Used inside the sidebar slot of LvSidebarLayout.
 */
defineProps({
