  ...
  <div :class="rootClasses">
    ...
    <div class="lv-sidebar-layout__main">
      ...
      <header v-if="$slots.topbar || showMobileToggle" class="lv-sidebar-layout__topbar">
        ...
        >
          <LvBaseIcon :name="mobileOpen ? 'close' : 'menu'" size="md" aria-hidden="true" />
        </button>
        <slot name="topbar" />
      </header>
...
/**
 * LvSidebarLayout — Two-column application shell with collapsible sidebar.
 *
 * Slots:
 *   sidebar-header  — logo / brand zone at the top of the sidebar
 *   sidebar         — nav links (use LvNavItem / LvNavGroup)
