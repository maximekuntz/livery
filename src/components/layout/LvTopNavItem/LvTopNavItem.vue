<template>
  ...
  >
    <LvBaseIcon v-if="icon" :name="icon" size="sm" aria-hidden="true" />
    <slot />
  </router-link>
  <a
    v-else
...
/**
 * LvTopNavItem — Navigation link styled for the top navbar.
 * Use inside the `nav` slot of LvTopNavLayout.
 */
