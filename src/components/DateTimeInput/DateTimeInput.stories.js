...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
**DateTimeInput** — Accessible combined date and time picker.
  ...
  render: (args) => ({
    ...
    template: `
      <div style="max-width: 320px; padding-bottom: 380px;">
        <DateTimeInput v-bind="args" v-model="value" />
...
export const ErrorState = {
  ...
  render: (args) => ({
    ...
    data() { return { value: null } },
    setup() { return { args } },
    template: `<div style="max-width: 320px;"><DateTimeInput v-bind="args" v-model="value" /></div>`,
  }),
  args: {
    label: 'Scheduled departure',
...
export const Disabled = {
  render: (args) => ({
    components: { DateTimeInput },
    setup() { return { args } },
    template: `<div style="max-width: 320px;"><DateTimeInput v-bind="args" model-value="2026-05-12T07:30" /></div>`,
  }),
