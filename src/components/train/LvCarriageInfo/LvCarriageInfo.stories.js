import { ref } from 'vue'
import LvCarriageInfo from './LvCarriageInfo.vue'
import LvTrainConsist from '../LvTrainConsist/LvTrainConsist.vue'

/** @type { import('@storybook/vue3-vite').Meta } */
export default {
  title: 'Train/CarriageInfo',
  component: LvCarriageInfo,
  tags: ['autodocs'],
  argTypes: {
    number: {
      control: 'text',
...
export const FirstClass = {
  ...
  render: (args) => ({
    components: { LvCarriageInfo },
    setup: () => ({ args }),
    template: '<LvCarriageInfo v-bind="args" />',
  }),
}
...
export const WithConsist = {
  render: () => ({
    components: { LvCarriageInfo, LvTrainConsist },
    setup() {
