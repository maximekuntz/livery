...
import { SERVICE_LABELS, SERVICE_ICONS, VALID_SERVICES } from './LvCarriageInfo.constants.js'

/**
 * LvCarriageInfo — Detail panel for a single rolling stock unit.
 *
 ...
 * alongside or below an `LvTrainConsist` diagram when the user selects
 * a carriage.
 *
 * Accessibility:
