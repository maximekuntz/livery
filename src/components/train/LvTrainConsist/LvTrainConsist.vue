...
import LvTrainCarriage from '../LvTrainCarriage/LvTrainCarriage.vue'

/**
 * LvTrainConsist — Full train formation diagram.
 *
...
const props = defineProps({
   ...
   * Each item is spread onto an `LvTrainCarriage` — any prop accepted by
