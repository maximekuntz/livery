<template>
  <div ref="rootEl" :class="rootClasses">
    ...
    <div class="lv-dt-input__wrapper">
      ...
      >
        <LvBaseIcon name="calendar" size="sm" class="lv-dt-input__icon" aria-hidden="true" />
...
/**
 * LvDateTimeInput — Accessible date-time picker: calendar + time columns in one panel.
 *
