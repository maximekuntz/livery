...
Theme IDs: \`tee\` · \`corail\` · \`orient-express\` · \`tgv-sud-est\`
        `,
      },
    },
  },
  ...
  render: () => ({
    ...
    setup() {
      const themePairs = [
        ...
        { id: themeTgvSudEst.id,         meta: themeTgvSudEst },
      ]
      return { themePairs }
    },
    template: `
...
export const TgvSudEst = {
  name: 'TGV Sud Est',
  render: () => ({
    components: { SampleCard },
    setup() {
      return { id: themeTgvSudEst.id, meta: themeTgvSudEst }
    },
    template: `<div style="padding:1rem"><SampleCard :themeId="id" :themeMeta="meta" /></div>`,
  }),
}
